...
type DBTokenActivityV2 struct {
	...
	TokenDataId             string   `protobuf:"bytes,6,opt,name=token_data_id,json=tokenDataId,proto3" json:"token_data_id,omitempty"`
	...
	TransactionTimestampInt int64    `protobuf:"varint,9,opt,name=transaction_timestamp_int,json=transactionTimestampInt,proto3" json:"transaction_timestamp_int,omitempty"`
...
func (m *DBTokenActivityV2) Reset()         { *m = DBTokenActivityV2{} }
func (m *DBTokenActivityV2) String() string { return proto.CompactTextString(m) }
func (*DBTokenActivityV2) ProtoMessage()    {}
func (*DBTokenActivityV2) Descriptor() ([]byte, []int) {
	return fileDescriptor_5c189d9007c69c61, []int{1}
}
func (m *DBTokenActivityV2) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *DBTokenActivityV2) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_DBTokenActivityV2.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *DBTokenActivityV2) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DBTokenActivityV2.Merge(m, src)
}
func (m *DBTokenActivityV2) XXX_Size() int {
	return m.Size()
}
func (m *DBTokenActivityV2) XXX_DiscardUnknown() {
	xxx_messageInfo_DBTokenActivityV2.DiscardUnknown(m)
}

var xxx_messageInfo_DBTokenActivityV2 proto.InternalMessageInfo

func (m *DBTokenActivityV2) GetType() string {
	if m != nil {
		return m.Type
	}
	return ""
...
func (m *DBTokenActivityV2) GetFromAddress() string {
	if m != nil {
...
func (m *DBTokenActivityV2) GetToAddress() string {
	if m != nil {
		return m.ToAddress
	}
	return ""
...
func (m *DBTokenActivityV2) GetCollectionId() string {
	if m != nil {
		return m.CollectionId
	}
	return ""
...
func (m *DBTokenActivityV2) GetTokenName() string {
	if m != nil {
		return m.TokenName
	}
	return ""
...
func (m *DBTokenActivityV2) GetTokenDataId() string {
	if m != nil {
		return m.TokenDataId
	}
	return ""
...
func (m *DBTokenActivityV2) GetTokenUrl() string {
	if m != nil {
		return m.TokenUrl
	}
	return ""
...
func (m *DBTokenActivityV2) GetTransactionTimestamp() string {
	if m != nil {
		return m.TransactionTimestamp
	}
	return ""
...
func (m *DBTokenActivityV2) GetTransactionTimestampInt() int64 {
	if m != nil {
		return m.TransactionTimestampInt
	}
	return 0
...
func (m *DBTokenActivityV2) GetTransactionVersion() uint64 {
	if m != nil {
...
type DBTokenActivitiesV2 struct {
	MintEvent            bool                 `protobuf:"varint,1,opt,name=mint_event,json=mintEvent,proto3" json:"mint_event,omitempty"`
	TransferOfferEvent   bool                 `protobuf:"varint,2,opt,name=transfer_offer_event,json=transferOfferEvent,proto3" json:"transfer_offer_event,omitempty"`
	TransferClaimEvent   bool                 `protobuf:"varint,3,opt,name=transfer_claim_event,json=transferClaimEvent,proto3" json:"transfer_claim_event,omitempty"`
	Activities           []*DBTokenActivityV2 `protobuf:"bytes,4,rep,name=activities,proto3" json:"activities,omitempty"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}

func (m *DBTokenActivitiesV2) Reset()         { *m = DBTokenActivitiesV2{} }
func (m *DBTokenActivitiesV2) String() string { return proto.CompactTextString(m) }
func (*DBTokenActivitiesV2) ProtoMessage()    {}
func (*DBTokenActivitiesV2) Descriptor() ([]byte, []int) {
	return fileDescriptor_5c189d9007c69c61, []int{2}
}
func (m *DBTokenActivitiesV2) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *DBTokenActivitiesV2) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_DBTokenActivitiesV2.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *DBTokenActivitiesV2) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DBTokenActivitiesV2.Merge(m, src)
}
func (m *DBTokenActivitiesV2) XXX_Size() int {
	return m.Size()
}
func (m *DBTokenActivitiesV2) XXX_DiscardUnknown() {
	xxx_messageInfo_DBTokenActivitiesV2.DiscardUnknown(m)
}

var xxx_messageInfo_DBTokenActivitiesV2 proto.InternalMessageInfo

func (m *DBTokenActivitiesV2) GetMintEvent() bool {
	if m != nil {
		return m.MintEvent
	}
	return false
...
func (m *DBTokenActivitiesV2) GetTransferOfferEvent() bool {
	if m != nil {
		return m.TransferOfferEvent
	}
	return false
}

func (m *DBTokenActivitiesV2) GetTransferClaimEvent() bool {
	if m != nil {
		return m.TransferClaimEvent
	}
	return false
}

func (m *DBTokenActivitiesV2) GetActivities() []*DBTokenActivityV2 {
	if m != nil {
		return m.Activities
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*DBTokenActivityV2)(nil), "mpb.DBTokenActivityV2")
	proto.RegisterType((*DBTokenActivitiesV2)(nil), "mpb.DBTokenActivitiesV2")
}
...
var fileDescriptor_5c189d9007c69c61 = []byte{
	...
	,
}
...
func (m *DBTokenActivityV2) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *DBTokenActivityV2) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *DBTokenActivityV2) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.TransactionVersion != 0 {
		i = encodeVarintDbNft(dAtA, i, uint64(m.TransactionVersion))
		i--
		dAtA[i] = 0x50
	}
	if m.TransactionTimestampInt != 0 {
	...
	if len(m.TokenUrl) > 0 {
		...
		i = encodeVarintDbNft(dAtA, i, uint64(len(m.TokenUrl)))
		i--
		dAtA[i] = 0x3a
	}
	if len(m.TokenDataId) > 0 {
	...
	if len(m.ToAddress) > 0 {
		...
		i = encodeVarintDbNft(dAtA, i, uint64(len(m.ToAddress)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.FromAddress) > 0 {
		...
		i = encodeVarintDbNft(dAtA, i, uint64(len(m.FromAddress)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Type) > 0 {
		i -= len(m.Type)
		copy(dAtA[i:], m.Type)
		i = encodeVarintDbNft(dAtA, i, uint64(len(m.Type)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *DBTokenActivitiesV2) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *DBTokenActivitiesV2) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *DBTokenActivitiesV2) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *DBTokenActivityV2) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.TransactionVersion != 0 {
		n += 1 + sovDbNft(uint64(m.TransactionVersion))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *DBTokenActivitiesV2) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *DBTokenActivityV2) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DBTokenActivityV2: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DBTokenActivityV2: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *DBTokenActivitiesV2) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DBTokenActivitiesV2: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DBTokenActivitiesV2: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MintEvent", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.MintEvent = bool(v != 0)
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TransferOfferEvent", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TransferOfferEvent = bool(v != 0)
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TransferClaimEvent", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 4:
			...
			m.Activities = append(m.Activities, &DBTokenActivityV2{})
